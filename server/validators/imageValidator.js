...
export const imageValidationRules = () => [
    ...
    body('objectName').optional().isString().withMessage('Object Name must be a string'), //  New validation for objectName
    body('creatorId').optional().isMongoId().withMessage('Creator must be a valid MongoDB ObjectId')
];
